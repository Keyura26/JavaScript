...
//  Promise.myPromiseALL([p0, p1, p2]).then(console.log, console.log);//first is success second is failure call back
...
// Promise.myPromiseALL([p0, p1, p2]).then((data)=>{console.log(data)},(err)=>{console.log(err)});