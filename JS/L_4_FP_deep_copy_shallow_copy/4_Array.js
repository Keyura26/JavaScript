...
let slicedArr = arr.slice(2, 4);
 // slice doesn't modifies the original array but returns the new array
console.log("slicedArr: ",arr,slicedArr);

// splice  modifies the original array but returns the new array
